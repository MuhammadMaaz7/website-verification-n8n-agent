...
export default function InputSection({ onValidate, isProcessing }: InputSectionProps) {
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto">
      <div className="relative backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-5 sm:p-6 md:p-8">
        {/* Tabs */}
            ...
            <div className="w-full">
              <div className="flex flex-col gap-3 sm:gap-4 items-center">
                <div className="flex-1 w-full">
                  ...
                  <label
                    htmlFor="csv-upload"
                    className="flex items-center gap-3 sm:gap-4 p-4 sm:p-5 border border-dashed border-white/20 rounded-xl hover:border-white/40 transition-all cursor-pointer bg-white/5 group"
                  >
                    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-white/15 transition-all flex-shrink-0">
                      <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white/70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a
                  ...
                  download
                  className="flex items-center gap-2 px-5 py-2.5 rounded-full text-xs sm:text-sm font-medium text-white/70 border border-white/15 backdrop-blur-md bg-white/5 hover:bg-white/10 hover:text-white transition-all w-full sm:w-auto justify-center"
                >
          ...
          {activeTab === "manual" && (
            <div className="w-full flex flex-col gap-3">
              <input
                ...
                className="w-full px-4 sm:px-5 py-3 sm:py-4 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-white/30 focus:ring-2 focus:ring-white/10 transition-all text-sm sm:text-base"
              />
              <input
                type="url"
                value={url}
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-white text-black font-bold rounded-full hover:bg-white/90 transition-all duration-200 shadow-lg shadow-white/20 disabled:bg-white/20 disabled:text-white/40 disabled:shadow-none disabled:cursor-not-allowed text-sm sm:text-base cursor-pointer"
              >

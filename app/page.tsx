...
export default function Home() {
  ...
  return (
    <div className="h-screen bg-[#0a0a1a] relative overflow-hidden flex flex-col">
      ...
      <nav className="relative z-10 flex justify-center pt-5 px-6 shrink-0" style={{ fontFamily: "'League Spartan', sans-serif" }}>
        <div className="flex items-center justify-between w-full max-w-3xl px-8 py-3 rounded-full border border-white/10 backdrop-blur-xl bg-white/5 shadow-lg shadow-black/10">
          <span
          ...
          <div className="flex items-center gap-8 text-md font-regular">
      ...
      {/* Main content area */}
      <main className="relative z-10 flex flex-col items-center justify-start flex-1 px-4 pt-58 overflow-y-auto">
        <div
        ...
        >
          {view === 'hero' ? (
            <>
              {/* Badge */}
              <div className="mb-5">
                <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full border border-white/15 backdrop-blur-md bg-white/5 text-white/60 text-xs">
                  Automated Website Validation
                </div>
              </div>

              {/* Heading */}
              <h1 className="text-1xl sm:text-2xl md:text-3xl font-bold text-center text-white mb-8 max-w-2xl leading-[1.15] tracking-tight">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-8 py-3.5 text-sm bg-white text-black font-semibold rounded-full hover:bg-white/90 transition-all duration-200 shadow-lg shadow-white/10 cursor-pointer"
                >
                  Get Started
                </button>
                <button 
                  onClick={() => switchTo('about')}
                  className="px-8 py-3.5 text-sm rounded-full font-semibold text-white/80 border border-white/20 backdrop-blur-md bg-white/5 hover:bg-white/10 hover:text-white transition-all duration-200 cursor-pointer"
                >
                  Learn More
                </button>
              </div>
            ...
            /* About Us Page */
            <div className="w-full max-w-4xl pb-12 pt-4">
              {/* Header */}
              <div className="text-center mb-10">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/15 backdrop-blur-md bg-white/5 text-white/60 text-xs mb-5">
                  S&P Global × FDSS DataFest
                </div>
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                ...
                <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6">
                  <div className="w-10 h-10 rounded-full bg-[#5227FF]/20 flex items-center justify-center mb-4">
                  ...
                  <h3 className="text-white font-bold text-lg mb-2">The Problem</h3>
                ...
                {/* Our Solution */}
                <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6">
                  <div className="w-10 h-10 rounded-full bg-[#10B981]/20 flex items-center justify-center mb-4">
                    <svg className="w-5 h-5 text-[#10B981]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <h3 className="text-white font-bold text-lg mb-2">Our Solution</h3>
                  <p className="text-white/50 text-sm leading-relaxed">
              ...
              <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 mb-8">
                <h3 className="text-white font-bold text-lg mb-3">The Hackathon</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="text-center p-4 rounded-xl bg-white/5 border border-white/5">
                    ...
                    <div className="text-white/40 text-xs">URLs Validated at Scale</div>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-white/5 border border-white/5">
                    <div className="text-2xl font-bold text-white mb-1">3</div>
                    <div className="text-white/40 text-xs">Input Methods</div>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-white/5 border border-white/5">
                    <div className="text-2xl font-bold text-[#10B981] mb-1">AI</div>
                    <div className="text-white/40 text-xs">Brand Verification</div>
                  </div>
                </div>
              </div>
